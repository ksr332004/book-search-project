    ...
    this.$get = function($state, layoutSizes) {
      ...
      function _factory() {
        ...
        this.clearMenuItems = function() {
            staticMenuItems = [];
            staticMenuItems.push.apply(staticMenuItems);
        };

        this.addNewMenuItem = function(menuItem) {
            staticMenuItems.push(menuItem);
            staticMenuItems.push.apply(staticMenuItems, menuItem);
        };
