(function() {
    ...
    /** @ngInject */
    function bookmarkPageCtrl($scope, $filter, $log, $state, $uibModal, toastr, baSidebarService, MessageService, SessionInfo) {
    	var vm = this;
    ...
    },
    {
      ...
      "url": "http://book.daum.net/detail/book.do?bookid=BOK00010503270AL"
        ...
        $scope.searchBookList = function(currentPage) {
          ...
          MessageService.interactWithServer('/bookmark/view', dataObject).success(function(data, status) {
            if (data) {
              console.log(data);
        ...
        $scope.open = function (page, size, book) {
          var modal = $uibModal.open({
            ...
            resolve: {
              ...
              MessageService.interactWithServer('/bookmark/delet', items).success(function(data, status) {
                  if (data) {
                      console.log(data);
